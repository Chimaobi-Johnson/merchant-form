...
const OwnerForm = ({ ISR, i, currentOwner }) => {
    ...
    <div className=" border-y-[1px] border-gray-500 py-8 my-8">
        ...
        <div className="flex justify-between items-center mt-6 [&>div]:w-[31%]">
            <Input inputName={`${currentOwner}_mobileNo`} type={'text'} label={'Home / Mobile Phone Number'} required placeholder={'Home / Mobile Phone Number'} />
        ...
        <div className="flex justify-between items-center mt-6 [&>div]:w-[31%]">
            <Input inputName={`${currentOwner}_SSN`} label={'Social Security Number (SSN)'} required placeholder={'Social Security Number (SSN)'} />
