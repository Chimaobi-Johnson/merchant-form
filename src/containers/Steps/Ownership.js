    ...
    return (
        <div>
            <div className="text-center">
                <p className=" text-center">Provide the following information for each individual who owns, directly or indirectly, 25 % or more of the equity interest of your business.
